...
- Google ML Crash Course - Overfitting (interactive, visual examples): https://developers.google.com/machine-learning/crash-course/overfitting/overfitting
...
- Neural networks with tabular data (rare tabular-first intro): https://www.youtube.com/watch?v=XxZ0BibMTjw
- StatQuest - Neural Networks Pt. 1: Inside the Black Box (20 min, builds from simple models to neural nets): https://www.youtube.com/watch?v=CqOfi41LfDw
- 3Blue1Brown - But What is a Neural Network? (19 min, best visual explanation of layers, neurons, activations): https://www.youtube.com/watch?v=aircAruvnKk
- 3Blue1Brown - Gradient descent, how neural networks learn (21 min, loss landscape visualization): https://www.youtube.com/watch?v=IHZwWFHWa-w
- StatQuest - Neural Networks Pt. 3: ReLU in Action (10 min, step-by-step examples): https://www.youtube.com/watch?v=68BZ5f7P94E
- StatQuest - Neural Networks Pt. 6: Cross Entropy (11 min, intuition for cross-entropy loss): https://www.youtube.com/watch?v=6ArSys5qHAU
- StatQuest - Stochastic Gradient Descent (11 min, basic GD to SGD and mini-batches): https://www.youtube.com/watch?v=vMh0zPT0tLI
- Deeplizard - PyTorch Training Loop Explained (short, forward-backward-update pattern): https://www.youtube.com/watch?v=XAkN07mEzpo
...
- Deep feedforward network for Titanic in PyTorch (practical tabular example): https://simulationbased.com/2021/02/03/a-deep-feedforward-network-in-pytorch-for-the-titanic-challenge/

## MLPs & Tabular Pipelines

- StatQuest - Confusion Matrix (6 min): https://www.youtube.com/watch?v=Kdsp6soqA7o
- Machine Learning Mastery - What is a Confusion Matrix (article, walks through with examples): https://machinelearningmastery.com/confusion-matrix-machine-learning/
...
- PyTorch tabular binary classification (simpler version, no embeddings, good warmup): https://medium.com/data-science/pytorch-tabular-binary-classification-a0368da5bb89
...
- Fireship - PyTorch in 100 Seconds (~2 min, quick overview): https://www.youtube.com/watch?v=ORMx45xqWkA
- Patrick Loeber - PyTorch Tutorial series (comprehensive, tensors through training loops): https://www.youtube.com/watch?v=EMXfZB8FVUA&list=PLqnslRFeH2UrcDBWF5mfPGpqQDSta6VK4
